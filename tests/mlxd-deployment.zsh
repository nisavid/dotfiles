...
darwin_data='{"chezmoi":{"os":"darwin","homeDir":"'${fixture_home}'"},"mlxctl":{"publicFixture":true,"sourceDir":"workspace/tool","binDir":".local/bin"}}'
linux_data='{"chezmoi":{"os":"linux","homeDir":"'${fixture_home}'"},"mlxctl":{"publicFixture":true,"sourceDir":"workspace/tool","binDir":".local/bin"}}'
...
data=$(chezmoi execute-template '{{ .mlxctl.binDir }}')
[[ $data == '.local/bin' ]] || \
  fail 'chezmoidata does not match the public mlxctl boundary'
