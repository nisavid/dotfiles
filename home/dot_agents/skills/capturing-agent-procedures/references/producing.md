...
3. Include behavioral tests of discovery and application using realistic inputs. Exercise reuse, placement, corrections, uncertain proposals, consumer prerequisites, and routine work with no capture. Static analysis alone does not establish the procedure's behavior.
