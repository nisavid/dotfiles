...
- rejects alternate object databases, grafted, shallow, or promisor repositories and remotes without the standard branch-cache refspec before trusting local graph state, and repeats the alternates guard immediately before every checkout-object operation;
