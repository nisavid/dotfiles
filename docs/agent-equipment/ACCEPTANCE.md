...
| `CAP-03` | Represent every provider payload with the catalog's secret-safe typed grammar, including profile references and hardened public HTTP URLs. | Valid stdio/HTTP and hostile provider fixtures |
