...
- A reserved SCITT evidence profile using the registered media types and an RFC 9995 SHA-512 bridge over exact <code>signature-envelope/v1</code> bytes, plus public disposable positive and hostile fixtures. This is a format and conformance surface, not a network or service dependency.
...
- What exact SCITT application profile makes two independent verifiers agree on the RFC 9995 bridge and RFC 9942 receipt corpus?
