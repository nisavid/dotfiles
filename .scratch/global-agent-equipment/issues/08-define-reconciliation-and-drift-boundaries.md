...
only a later apply may reconcile it. Unsupported portable operations, including
opaque Cursor user-plugin state, are modeled as `manual`, verified through
supported observable surfaces where possible, and reported with remediation
instructions instead of editing caches or databases.
