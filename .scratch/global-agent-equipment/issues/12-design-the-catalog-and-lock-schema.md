# Design the catalog and lock schema
...
semantics, reproducible artifact references, exactly-one provenance owner per
active route, unknown/suppressible/unsuppressible native auto-update controls,
reviewed native-rolling observed-version baselines, manager-driven-drift state,
and generated lock fields make desired state reviewable without duplicating
derived inventory?
