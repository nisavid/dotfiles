...
A generated repo-owned resolved lock governs deterministic restore, exact
equipment inventory, provider coverage, and harness projections. The native
global `skills` lock remains useful manager-owned provenance and import
evidence; the update workflow should derive from it where useful instead of
hand-copying its inventory. It is not the sole authority because installed
